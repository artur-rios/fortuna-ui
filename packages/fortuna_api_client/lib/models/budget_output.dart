...
import 'budget_category_output.dart';
import 'budget_consumption_output.dart';
import 'budget_period_type.dart';

part 'budget_output.g.dart';
...
class BudgetOutput {
  ...
  final BudgetConsumptionOutput? currentPeriod;
  final String? id;
  ...
  Map<String, Object?> toJson() => _$BudgetOutputToJson(this);
}
